...
| 31 | E | observe_listing_images | infra\jobs\labeling\image-pipeline\src\observe_images_playwright.py |
...
|---:|---|---|
| 93 | reverseOnce | infra\jobs\observers\reverse-monitor\src\reverse_monitor.go:1436 |
...
| 32 | runRepair | infra\jobs\observers\reverse-monitor\src\reverse_monitor.go:2147 |
...
| 25 | runAuditStatus | infra\jobs\observers\reverse-monitor\src\reverse_monitor.go:1905 |
| 23 | observeOnce | infra\jobs\observers\discovery\src\fetchd.go:1752 |
| 23 | observeOnce | infra\jobs\observers\discovery\src\main.go:1393 |
| 23 | runTest | infra\jobs\observers\reverse-monitor\src\reverse_monitor.go:2064 |
| 20 | selectAndRun | infra\jobs\quality-control\db-healing\src\post_sold_audit.go:887 |
| 20 | consumeDetails | infra\jobs\observers\discovery\src\fetchd.go:1572 |
| 20 | consumeDetails | infra\jobs\observers\discovery\src\main.go:1213 |
| 19 | smartGET | infra\jobs\observers\reverse-monitor\src\reverse_monitor.go:458 |
| 17 | (*HTTPAdapter).smartGET | infra\jobs\auditors\older21days-tail-audit\src\marketplace_adapter.go:495 |
| 17 | (*AutoTuner).Recalc | infra\jobs\observers\discovery\src\fetchd.go:817 |
| 17 | (*AutoTuner).Recalc | infra\jobs\observers\discovery\src\main.go:458 |
