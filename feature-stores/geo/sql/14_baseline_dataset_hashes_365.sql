-- 14_baseline_dataset_hashes_365.sql
-- Dataset hash baselines for last 365 days (policy).
...
WITH picked AS (
  ...
  FROM (
    ...
    FROM ml.geo_feature_store_t0_v1_v
...
SELECT
  ...
  p.t0_day,
  2000,
  audit.dataset_sha256('ml.geo_feature_store_t0_v1_v'::regclass, p.t0_day, 2000)
FROM picked p
