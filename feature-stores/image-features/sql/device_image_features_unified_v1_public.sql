DROP VIEW IF EXISTS ml.device_image_features_unified_v1;

CREATE VIEW ml.device_image_features_unified_v1 AS
WITH assets AS (
  SELECT
    generation,
    listing_id,
...
/* Fix for your error:
   ml.device_image_damage_features_v1 does NOT have dmg_mean_hq_struct,
...
SELECT
  ...
  /* ============================================================
     ACCESSORIES (ml.device_image_accessory_features_v1)
     ============================================================ */
  ...
  /* ============================================================
     COLOR (ml.device_image_color_features_v1)
     ============================================================ */
  ...
  /* ============================================================
     DAMAGE (ml.device_image_damage_features_v1)
     ============================================================ */
...
LEFT JOIN ml.device_image_accessory_features_v1 acc
  ON acc.generation = a.generation AND acc.listing_id = a.listing_id
LEFT JOIN ml.device_image_color_features_v1 col
  ON col.generation = a.generation AND col.listing_id = a.listing_id
LEFT JOIN ml.device_image_damage_features_v1 dmg
