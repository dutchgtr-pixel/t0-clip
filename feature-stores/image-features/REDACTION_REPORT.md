...
- `docs/Documentation_device_image_features_unified_v1_public.md` (from `Documentation____ device_image_features_unified_v1 — Unified Vision Feature Store.txt`)
- `docs/Documentation_vision_color_feature_store_public.md` (from `Documentation____ Vision Color Feature Store.txt`)
- `docs/Documentation_device_image_damage_features_v1_public.md` (from `Documentation____ml.device_image_damage_features_v1.txt`)
- `docs/Documentation_vision_accessory_feature_store_public.md` (from `Documentation____Vision Accessory Feature Store.txt`)
- `sql/device_image_damage_features_v1_public.sql` (from `FEATURE_STORE_IMAGE_DAMAGE_SQL.txt`)
- `sql/device_image_accessory_features_v1_public.sql` (from `SQ Drop and create ml device_image_accessory_features_v1.txt`)
- `sql/device_image_color_features_v1_public.sql` (from `SQL ml.device_image_color_features_v1.txt`)
- `sql/device_image_features_unified_v1_public.sql` (from `SQL ml.device_image_features_unified_v1.txt`)
